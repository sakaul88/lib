...
class TestUtils(unittest.TestCase):
    ...
    def test_discover_github_latest_patch_version(self):
        ...
        version_not_passing_patch = discover_github_latest_patch_version('1.12', release_url)
        version_passing_patch = discover_github_latest_patch_version('1.12.1', release_url)
